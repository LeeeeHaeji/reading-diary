  ...
  return (
    <>
      <main className=" bg-primary px-5 pt-20">
        <h2>
          <img src="/img/logo.png" alt="회원가입" className="mx-auto mb-11 w-[249.6px]" />
        </h2>

        <form
          onSubmit={handleSubmit}
          className="before:content-[' '] after:content-[' '] relative mx-auto max-w-[447px] rounded-xl 
          bg-point before:absolute before:left-[-240px] before:top-[180px] 
          before:h-[254.58px] before:w-[260px] before:bg-[url('/img/leaf-left.png')] 
          before:bg-[length:260px_254.58px] after:absolute after:right-[-240px] after:top-[180px] after:h-[254.58px] after:w-[260px] after:bg-[url('/img/leaf-right.png')] after:bg-[length:260px_254.58px]"
        >
